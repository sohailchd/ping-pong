...
function moveball2()
{
      var pH= parseInt($("#playground").height());
	  var pW= parseInt($("#playground").width());
	  var ball2 = ping.ball2;
	  
	  
	  
	  ball2.x +=ball2.speed*ball2.dirX;
	  ball2.y +=ball2.speed*ball2.dirY;
	  ...
	  //Check the boundary condition
	  //top 
	  if(ball2.y+ball2.speed*ball2.dirY < 0)
	  {
	     ball2.dirY = 1;
	  }
	  //bottom
	  if(ball2.y+ball2.speed*ball2.dirY > pH)
	  {
	     ball2.dirY = -1;
	  
	  }
	  //left
	  if(ball2.x+ball2.speed*ball2.dirX < 0)
	  {
	  ...
	  //right
	  if(ball2.x+ball2.speed*ball2.dirX >= pW)
	  {
	     //ball2.x= 300;
		// ball2.y=200;
		 $("#ball2").css({
	  ...
	  //check the collision
	  if(ball2.x+ball2.speed*ball2.dirX <= paddleAX)
	  {
	      if(ball2.y+ball2.speed*ball2.dirY >= paddleAYtop-10 && ball2.y+ball2.speed*ball2.dirY <= paddleAYbottom)
		  {
		     ball2.dirX= 1;
			// ball2.speed = ball2.speed* 1.05;
		  }
	  }
	  ...
	  //check the collision
	  if(ball2.x+ball2.speed*ball2.dirX >= paddleBX-15)
	  {
	      if(ball2.y + ball2.speed*ball2.dirY >= paddleBYtop-15 && ball2.y+ball2.speed*ball2.dirY <= paddleBYbottom)
		  {
		     ball2.dirX= -1;
			// ball2.speed = ball2.speed* 1.05;
